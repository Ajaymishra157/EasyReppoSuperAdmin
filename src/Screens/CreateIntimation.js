...
const CreateIntimation = () => {
    ...
    const [rcNoerror, setRCNoError] = useState('');
    ...
    const validateForm = () => {
        ...
        if (!rcNo || rcNo.trim() === '') {
            setRCNoError('Rc No is required');
            isValid = false;
        }
    ...
    const PrePostEmailSendApi = async (type) => {
        ...
        if (!id) {
            ...
            console.log("Intimation submission failed. Please try again.");
          ...
          <div class="header-title">POST POLICE REPO INTIMATION OF VEHICLE ${rcNo || '----------'} </div>
            ...
            <table>
              ...
              <tr><th>Chassis No</th>  <td><strong>:</strong></td><td>${chasisNo || '----------'}</td></tr>
                <tr><th>Reppossession Address</th>  <td><strong>:</strong></td><td>${ReppoAddress || '----------'}</td></tr>
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#f7f7f7' }}>
            ...
            <ScrollView
                contentContainerStyle={{ flexGrow: 1, paddingBottom: keyboardVisible ? 400 : 80 }}
                keyboardShouldPersistTaps="handled">
                <View style={{ padding: 20 }}>

                    <View style={{ marginBottom: 20, borderWidth: 1, borderBottomWidth: 0 }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', borderBottomWidth: 1, padding: 8, alignItems: 'center' }}>
                            <Text style={{ width: '30%', fontSize: 12, fontFamily: 'Inter-Bold', color: 'black', textTransform: 'uppercase' }}>Loan No</Text>
                            <TextInput
                                style={{ width: '70%', borderWidth: 1, borderColor: 'black', borderRadius: 8, padding: 6, fontSize: 12, fontFamily: 'Inter-Regular', color: '#555' }}
                                value={loanNo}
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', borderBottomWidth: 1, padding: 8, alignItems: 'center' }}>
                            <Text style={{ width: '30%', fontSize: 12, fontFamily: 'Inter-Bold', color: 'black', textTransform: 'uppercase' }}>Customer Name <Text style={{ color: 'red', fontFamily: 'Inter-Bold', }}>*</Text></Text>
                            <View style={{ width: '100%' }}>
                                <TextInput
                                    style={{ width: '70%', borderWidth: 1, borderColor: customerNameError ? 'red' : 'black', borderRadius: 8, padding: 6, fontSize: 12, fontFamily: 'Inter-Regular', color: '#555' }}
                                    value={customerName}
                                    onChangeText={(text) => {
                                ...
                                />
                                {customerNameError ? (
                                    <Text style={{ color: 'red', fontSize: 10, marginTop: 4, fontFamily: 'Inter-Regular' }}>
                                        {customerNameError}
                                    </Text>
                                ) : null}
                            </View>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', borderBottomWidth: 1, padding: 8, alignItems: 'center' }}>
                            <Text style={{ width: '30%', fontSize: 12, fontFamily: 'Inter-Bold', color: 'black', textTransform: 'uppercase' }}>RC No <Text style={{ color: 'red', fontFamily: 'Inter-Bold', }}>*</Text></Text>
                            <View style={{ width: '100%' }}>
                                <TextInput
                                    style={{ width: '70%', borderWidth: 1, borderColor: rcNoerror ? 'red' : 'black', borderRadius: 8, padding: 6, fontSize: 12, fontFamily: 'Inter-Regular', color: '#555' }}
                                    value={rcNo}
                                    onChangeText={(text) => {
                                        setRcNo(text);
                                        if (text.trim() !== '') {
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', borderBottomWidth: 1, padding: 8, alignItems: 'center' }}>
                            <Text style={{ width: '30%', fontSize: 12, fontFamily: 'Inter-Bold', color: 'black', textTransform: 'uppercase' }}>Product <Text style={{ color: 'red', fontFamily: 'Inter-Bold', }}>*</Text></Text>
                            <View style={{ width: '100%' }}>
                                <TextInput
                                    style={{ width: '70%', borderWidth: 1, borderColor: productError ? 'red' : 'black', borderRadius: 8, padding: 6, fontSize: 12, fontFamily: 'Inter-Regular', color: '#555' }}
                                    value={product}
                                    onChangeText={(text) => {
                                        setProduct(text);
                                        if (text.trim() !== '') {
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', borderBottomWidth: 1, padding: 8, alignItems: 'center' }}>
                            ...
                            <TextInput
                                style={{ width: '70%', borderWidth: 1, borderColor: 'black', borderRadius: 8, padding: 6, fontSize: 12, fontFamily: 'Inter-Regular', color: '#555', color: '#555' }}
                                value={chasisNo}
                            ...
                            >
                                <TextInput
                                    style={{
                                        ...
                                        fontFamily: 'Inter-Regular',
                                        color: 'black',
                                        minHeight: 50, // starting height
                                        maxHeight: 150, // optional max height
                                        textAlignVertical: 'top', // important for Android to start at top
                                    }}
                                    multiline
                                    placeholder="Enter Agent Address"
                                    placeholderTextColor="grey"
                                    value={ReppoAddress}
                                    onChangeText={setReppoAddress}
                                />
                            </View>
                        </View>
                    )}
