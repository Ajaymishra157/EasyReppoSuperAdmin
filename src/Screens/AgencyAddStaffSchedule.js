...
const AgencyAddStaffSchedule = () => {
    ...
    const { staff_id, staff_name, start_date, end_date, Schedule_id, agencyId, agencyName, agencyDetail } =
        route.params || {};
        ...
        <View style={{ flex: 1, backgroundColor: '#f7f7f7' }}>
            ...
            <View
                ...
                <Text
                    ...
                    {staff_id ? 'Update Agency Schedule' : 'Add Agency Schedule'}
                </Text>
            </View>
            {/* Form Section */}
            <ScrollView
...
export default AgencyAddStaffSchedule;
