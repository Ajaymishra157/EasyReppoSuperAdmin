...
const IntimationScreen = () => {
  ...
  const AddIntimation = async (shouldNavigateBack = true) => {
    ...
    try {
      ...
      console.log("🚗 vehicleDetails object:", vehicleDetails);

      console.log("vehicle_id (full_vehicle_id):", vehicleDetails?.full_vehicle_id);
      console.log("loan_no (vehicle_agreement_no):", vehicleDetails?.vehicle_agreement_no);
      console.log("rc_no (vehicle_registration_no):", vehicleDetails?.vehicle_registration_no);
      console.log("chassis_no (vehicle_chassis_no):", vehicleDetails?.vehicle_chassis_no);
      console.log("engine_no (vehicle_engine_no):", vehicleDetails?.vehicle_engine_no);
      console.log("product (vehicle_product):", vehicleDetails?.vehicle_product);
      console.log("customer_name (vehicle_customer_name):", vehicleDetails?.vehicle_customer_name);
      console.log("customer_name (vehicle_customer_name):", vehicleDetails?.vehicle_finance_name);


      console.log("SelectedAgency:", SelectedAgency);
      console.log("SendAgency:", SendAgency);
      console.log("selectedAreaId:", selectedAreaId);
      console.log("ReppoAddress:", ReppoAddress);
      console.log("ReppoAgency:", ReppoAgency);
    ...
    <View style={{ flex: 1, backgroundColor: '#f7f7f7' }}>
      ...
      <View
        ...
        {(
          ...
          permissions.intimation.whatsapp
        ) && (
        ...
        <View style={{ padding: 20 }}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', flexWrap: 'wrap' }}>
            ...
            {(
              userType === 'SuperAdmin' ||
              !permissions.intimation ||
              permissions.intimation.prepostmail
