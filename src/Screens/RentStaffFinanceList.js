...
const RentStaffFinanceList = () => {
    ...
    console.log("staff id yeh hai bro", staff_id, staff_name)
    ...
    const AgencyStaffLogout = async (navigation, confirmLogout) => {
        try {
            ...
            if (result.code === 200) {
                ...
                console.log(result.message || 'Failed to logout staff');
            }
        } catch (error) {
            console.log('Logout error:', error.message);
            console.log('Error logging out staff');
        }
    };
    ...
    const fetchFinanceList = async () => {
        ...
        try {
            ...
            const response = await fetch(ENDPOINTS.Rent_Finance_List(rentAgencyId, staff_id));
            const result = await response.json();
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await fetch(ENDPOINTS.rent_finance_update, {
                method: 'POST',
                headers: {
...
export default RentStaffFinanceList;
